...
EventListenerGesture::~EventListenerGesture()
{
    CCLOG("In the destructor of EventListenerGesture, %p", this);
}
...
Vec2 EventListenerGesture::getTouchStartPos()
{
	return _touchStartPos;
}

float EventListenerGesture::getSwipeDiff()
{
    return _swipeDiff;
}

void EventListenerGesture::setEnabled(bool enabled)
{
    _isEnabled = enabled;
   _isTouched = false; 
}